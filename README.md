...
* create a clone of [Gen3 Data Commons Application](https://https://github.com/uc-cdis/commons-frontend-app/)  
...
Changes to the Gen3 Data Commons Application can be pulled from the the repository
